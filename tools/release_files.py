...
VERSION = "0.7.2"
REQUIRED_RULE_IDS = ('COMMUNICATION.RU.001', 'BEHAVIOR.PILLARS.001', 'FOUNDATION.CONTRACT.001', 'REUSE.EXISTING.001', 'ITERATION.CYCLE.001', 'TRUTH.REALITY.001', 'TRUTH.EVIDENCE.001', 'CHOICE.DESIRE_ACTION.001', 'BOUNDARIES.FRIENDSHIP.001', 'SYNC.STATES.001', 'SYNC.AUTHORITY.001', 'CANON.MERGE.001', 'BRAND.EXACT.001', 'COMMANDS.ALIASES.001', 'PPD.PRODUCT_PROOF.001', 'LOAD.RECEIPT.001', 'RELEASE.SCOPE.001', 'PROGRESSION.LEVEL_CURVE.001', 'PROGRESSION.REWARD_DISPLAY.001')
